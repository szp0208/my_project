function plot_km (container_name, raw_data, sp) {
    ...
    window.kmimgData.cutpoint = cutpoint;
    window.kmimgData.max = data_sorted[data_sorted.length - 1];
    window.kmimgData.min = data_sorted[0];
    console.log('石志鹏',cutpoint);
    ...
    svg.append("g")
        ...
        .style("fill", "black")
        .style("font-size", "1.0em")
        .text("Expression"+ sp.expression_unit +":");
